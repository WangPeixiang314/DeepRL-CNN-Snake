...
class SnakeGame:
    ...
    def get_state(self):
        ...
        return np.concatenate([
            ...
            get_all_grid_view_nb(self.snake, self.food, self.width, self.height, Config.BLOCK_SIZE),  # 整个地图的直接网格信息展平
            get_CNN_all_grid_view(self),  # 全局地图的CNN特征
            get_CNN_local_grid_view(self),  # 局部视野的CNN特征
